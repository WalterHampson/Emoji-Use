...
2. Prepare your emoji usage dataset in CSV format with at least the following columns:
...
4. Run the script to display the most popular emojis and generate the plot:
